...
void HAL_PCD_MspInit(PCD_HandleTypeDef *hpcd) {
    ...
    if (hpcd->Instance == USB_OTG_FS) {
        ...
        GPIO_InitStruct.Pin =
            GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_5 | GPIO_PIN_10 | GPIO_PIN_2 | GPIO_PIN_12 | GPIO_PIN_13;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Alternate = GPIO_AF10_OTG_HS;
...
static USBD_StatusTypeDef USBD_LL_Setup_Fifo(void) {
    ...
    rx_fifo_size =
        (USBD_AUDIO_CONFIG_PLAY_MAX_PACKET_SIZE > 64) ? (USBD_AUDIO_CONFIG_PLAY_MAX_PACKET_SIZE + 3U) / 4 : 16;
    ...
    rx_fifo_size += (5 * 1 /*number of control endpoints*/ + 8 + 1 /* for status information*/ +
                     2 * 6 /*number of OUT endpoints*/ + 1 /*for Global NAK*/);
