...
#define USB_AUDIO_CONFIG_PLAY_FREQ_COUNT                                           \
    (USB_AUDIO_CONFIG_PLAY_USE_FREQ_192_K + USB_AUDIO_CONFIG_PLAY_USE_FREQ_96_K +  \
     USB_AUDIO_CONFIG_PLAY_USE_FREQ_48_K + USB_AUDIO_CONFIG_PLAY_USE_FREQ_44_1_K + \
     USB_AUDIO_CONFIG_PLAY_USE_FREQ_32_K + USB_AUDIO_CONFIG_PLAY_USE_FREQ_16_K + USB_AUDIO_CONFIG_PLAY_USE_FREQ_8_K)
...
#endif
/* Macro to compute the count of supported frequency */
#define USB_AUDIO_CONFIG_RECORD_FREQ_COUNT                                             \
    (USB_AUDIO_CONFIG_RECORD_USE_FREQ_192_K + USB_AUDIO_CONFIG_RECORD_USE_FREQ_96_K +  \
...
#define USBD_AUDIO_CONFIG_PLAY_MAX_PACKET_SIZE                                                                       \
    ((uint16_t)(AUDIO_USB_MAX_PACKET_SIZE((USB_AUDIO_CONFIG_PLAY_FREQ_MAX + 1), USB_AUDIO_CONFIG_PLAY_CHANNEL_COUNT, \
                                          USB_AUDIO_CONFIG_PLAY_RES_BYTE)))
#else /* USE_AUDIO_PLAYBACK_USB_FEEDBACK */
#define USBD_AUDIO_CONFIG_PLAY_MAX_PACKET_SIZE                                                                   \
    ((uint16_t)(AUDIO_USB_MAX_PACKET_SIZE((USB_AUDIO_CONFIG_PLAY_FREQ_MAX), USB_AUDIO_CONFIG_PLAY_CHANNEL_COUNT, \
                                          USB_AUDIO_CONFIG_PLAY_RES_BYTE)))
...
#define USBD_AUDIO_CONFIG_RECORD_MAX_PACKET_SIZE                                  \
    ((uint16_t)(AUDIO_USB_MAX_PACKET_SIZE((USB_AUDIO_CONFIG_RECORD_FREQ_MAX + 1), \
                                          USB_AUDIO_CONFIG_RECORD_CHANNEL_COUNT, USB_AUDIO_CONFIG_RECORD_RES_BYTE)))
#else /*USE_AUDIO_RECORDING_USB_NO_REMOVE */
#define USBD_AUDIO_CONFIG_RECORD_MAX_PACKET_SIZE                                                                   \
    ((uint16_t)(AUDIO_USB_MAX_PACKET_SIZE(USB_AUDIO_CONFIG_RECORD_FREQ_MAX, USB_AUDIO_CONFIG_RECORD_CHANNEL_COUNT, \
