...
#define REG_STANDBY 0x02
#define REG_MUTE 0x03
#define REG_PLL 0x04
#define REG_OSCILLATOR 0x05
#define REG_DEVICE_COMMUNICATION 0x06
#define REG_SDOUT 0x07
#define REG_GPIO 0x08
#define REG_BCLK 0x09
#define REG_DSP_GPIO_INPUT 0x0A
#define REG_CLOCK_CONFIGURATION 0x0C
#define REG_PLL_CLOCK_CONFIGURATION 0x0D
#define REG_PLLP 0x14
#define REG_PLL_J 0x15
#define REG_PLL_D_MSB 0x16
#define REG_PLL_D_LSB 0x17
#define REG_PLL_R 0x18
#define REG_DSP_CLOCK_DIVIDER 0x1B
#define REG_DAC_CLOCK_DIVIDER 0x1C
#define REG_NCP_CLOCK_DIVIDER 0x1D
#define REG_OSR_CLOCK_DIVIDER 0x1E
#define REG_MASTER_MODE_BCK_DIVIDER 0x20
#define REG_MASTER_MODE_LRCK_DIVIDER 0x21
#define REG_FS_SPEED_MODE 0x22
#define REG_PIN_INTERRUPT 0x23
#define REG_CLOCK_DETECTION_CONFIG 0x25
#define REG_I2S_CONFIG 0x28
#define REG_I2S_SHIFT 0x29
#define REG_DAC_DATA_PATH 0x2A
#define REG_DSP_PROGRAM_SELECTION 0x2B
#define REG_CLOCK_MISSING_DETECTION 0x2C
#define REG_INTERRUPT_MASK 0x2D
#define REG_AUTO_MUTE 0x3B
#define REG_DIGITAL_VOLUME_CONTROL 0x3C
#define REG_LEFT_DIGITAL_VOLUME 0x3D
#define REG_RIGHT_DIGITAL_VOLUME 0x3E
#define REG_DIGITAL_VOLUME_RAMP_CONFIG 0x3F
#define REG_DIGITAL_VOLUME_EMERGENCY_RAMP_CONFIG 0x40
#define REG_AUTO_MUTE_CONTROL 0x41
#define REG_GPIO0_OUTPUT 0x53
#define REG_GPIO2_OUTPUT 0x55
#define REG_GPIO_OUTPUT_CONTROL 0x56
#define REG_GPIO_OUTPUT_INVERSION 0x57
#define REG_DETECTED_CLOCK_CONFIG 0x5B
#define REG_DETECTED_BCK_RATIO 0x5D
#define REG_CLOCK_DETECTOR 0x5E
#define REG_GPIO_INPUT_STATE 0x77
#define REG_AUTO_MUTE_FLAG 0x78
#define REG_DAC_MODE 0x79
#define REG_BOOK 0x7f

/** book0 page1 */
#define REG_ANALOG_GAIN_CONTROL 0x02
